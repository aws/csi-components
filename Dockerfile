...
FROM --platform=$BUILDPLATFORM public.ecr.aws/docker/library/golang:1.26@sha256:c7e98cc0fd4dfb71ee7465fee6c9a5f079163307e4bf141b336bb9dae00159a5 AS builder
