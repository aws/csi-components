...
FROM --platform=$BUILDPLATFORM public.ecr.aws/docker/library/golang:1.26@sha256:b900de91b15b2e2953d930ece1d0ecff0a1590ab2006088d20dcf0f56f1e979f AS builder
