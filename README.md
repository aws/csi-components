...
| ------------- | ------------- | ------------- |
| [external-attacher](https://github.com/kubernetes-csi/external-attacher) | v4.12.0-eksbuild.5 | `public.ecr.aws/csi-components/csi-attacher:v4.12.0-eksbuild.5` |
| [node-driver-registrar](https://github.com/kubernetes-csi/node-driver-registrar) | v2.17.0-eksbuild.5 | `public.ecr.aws/csi-components/csi-node-driver-registrar:v2.17.0-eksbuild.5` |
| [external-provisioner](https://github.com/kubernetes-csi/external-provisioner) | v6.3.0-eksbuild.4 | `public.ecr.aws/csi-components/csi-provisioner:v6.3.0-eksbuild.4` |
