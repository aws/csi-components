...
| [external-provisioner](https://github.com/kubernetes-csi/external-provisioner) | v6.0.0-eksbuild.1 | `public.ecr.aws/csi-components/csi-provisioner:v6.0.0-eksbuild.1` |
